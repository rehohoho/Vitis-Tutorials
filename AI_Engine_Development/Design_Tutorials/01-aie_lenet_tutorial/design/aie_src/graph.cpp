...
adf::PLIO *attr_i1 = new adf::PLIO("prod_in1", adf::plio_64_bits, "data/0_1/matA_in_64plio.txt");
adf::PLIO *attr_i2 = new adf::PLIO("prod_in3", adf::plio_64_bits, "data/0_2/matA_in_64plio.txt");
adf::PLIO *attr_i3 = new adf::PLIO("prod_in5", adf::plio_64_bits, "data/0_3/matA_in_64plio.txt");
adf::PLIO *attr_i4 = new adf::PLIO("prod_in7", adf::plio_64_bits, "data/0_5/matA_in_64plio.txt");
